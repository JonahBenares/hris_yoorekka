                                    ...
                                    <tr style="background: #fff2">                                      
                                        ...
                                        <td >
                                            <center>
                                                ...
                                                <a onclick="confirmationDelete(this);return false;" href='delete_dept.php?id=<?php echo $row['dept_id']; ?>' class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"  alt='Delete'><span class="zmdi zmdi-delete"></span></a> 
                                                <?php if($row['personal_id']!=0){ ?> 
